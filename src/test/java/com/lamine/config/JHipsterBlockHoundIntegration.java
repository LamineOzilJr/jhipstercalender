...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.lamine.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.lamine.security.DomainUserDetailsService", "createSpringSecurityUser");
